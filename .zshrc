...
export ZSH="/Users/dlanotte/.oh-my-zsh"
...
# source /Users/zxcvbinz/.Sublivim/sublivimrc.sh
...
export PATH="/goinfre/dlanotte/.test/.brew/opt/openjdk/bin:$PATH"
alias t_brew="~/goinfre/dlanotte/.test/.brew/opt/openjdk/bin"
export PATH="$HOME/.42utils-commands:$PATH"
export HOMEBREW_CASK_OPTS="--appdir=~/goinfre/.Applications --caskroom=~/.goinfre/.test/.brew/Caskroom"
42software

if [ -d "$HOME/goinfre/.valgrind/" ]; then
	export PATH="$HOME/goinfre/.valgrind/bin:$PATH";
else
